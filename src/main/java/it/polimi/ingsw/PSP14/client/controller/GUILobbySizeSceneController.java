...
public class GUILobbySizeSceneController {
    ...
    @FXML
    protected void didClickTwoPlayers(ActionEvent event) throws InterruptedException {
    ...
    @FXML
    protected void didClickThreePlayers(ActionEvent event) throws InterruptedException {
